        ...
        if _G.FastAttack then
            if typeof(xShadowx) == "table" then
                pcall(function()
                    ...
                    xShadowx.activeController.hitboxMagnitude = 500
...
Stats:Button("Stat Refund",function()
  game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Fragments","Buy",1,2)
  end)
...
Misc:Button("Awakening Togglers", function()
...
Misc:Button("Unlock DonSwan wip", function()
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("GetUnlockables").FlamingoAccess = 1
end)
    ...
    function infinitestam()
        LocalPlayer.Character.Energy.Changed:connect(function()
            if InfiniteEnergy then
                LocalPlayer.Character.Energy.Value = 9999
            end 
        end)
    end
...
Op:Label("Beli : "..game.Players.LocalPlayer.Data.Beli.Value)

Op:Label("Fragments : "..game.Players.LocalPlayer.Data.Fragments.Value)
